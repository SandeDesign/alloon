...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ onMenuClick }) => {
  ...
  return (
    <>
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-1 py-1 z-30 shadow-lg">
        <div className="flex justify-around items-center">
          ...
          <button
            onClick={onMenuClick}
            className="flex flex-col items-center justify-center px-2 py-2 min-w-0 flex-1 text-xs font-medium text-gray-500 hover:text-gray-700 transition-all duration-200 hover:bg-gray-50 rounded-lg"
          >
