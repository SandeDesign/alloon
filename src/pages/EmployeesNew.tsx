    ...
    try {
      const employeeData = {
        ...
        contractInfo: {
          ...
          // ✅ FIX: Zet datumstrings correct om naar Date objects
          startDate: data.startDate ? new Date(data.startDate + 'T00:00:00Z') : new Date(),
          endDate: data.endDate ? new Date(data.endDate + 'T00:00:00Z') : undefined,
